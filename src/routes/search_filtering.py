...
async def search_images_by_tags(tags: List[str] = Query(...), rating: Optional[int] = None, date: Optional[date] = None,
...
async def search_images_by_description(description: str = Query(...), rating: Optional[int] = None,
                                       date: Optional[date] = None, db: Session = Depends(get_db)):
    try:
